...
//        for (int level2 = LOCAL_LEVEL; level2 <= REMOTE_LEVEL ; ++level2)
//        {
//          my_debug("Level2:"<<level2<<"\t Cells:"<<level_to_cell_map[level2].size()<<"\t Cells:"<<std::count(cell_level_info.begin(), cell_level_info.end(), level2) );
//        }
      }
